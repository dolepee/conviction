...
- Production runtime: v0.4.16 declares exact A2MCP replay inputs, refuses unsupported EOA makers before payment, requires exact official-plugin dry-run agreement, permits a payment-bound 30-minute OPEN card refresh without charging again, and supports both current and legacy buyer-controlled Polymarket deposit wallets
