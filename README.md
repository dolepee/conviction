...
- Production runtime: v0.4.12 expands Buyer Readiness with a complete setup plan, unavoidable approval disclosure, exact funding destinations, labeled venue minimums, and commit-bound write-once live evidence while preserving the v0.4.10 market lookup fix, v0.4.9 signed-proof runtime, issuer-signed public proofs, YES/NO CTF label binding, and immutable executor v6
