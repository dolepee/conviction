...
- Production runtime: v0.4.15 declares exact A2MCP replay inputs, refuses unsupported EOA makers before payment, requires exact official-plugin dry-run agreement, and permits a payment-bound 30-minute OPEN card refresh without charging again
