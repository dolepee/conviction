...
- Production runtime: v0.4.9 is the signed-proof hotfix release for `https://conviction-bay.vercel.app`; it requires issuer-signed public proofs, preserves YES/NO CTF label binding, and uses immutable executor v6 without changing fees, trade bounds, or custody
