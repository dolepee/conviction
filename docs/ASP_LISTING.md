...
Status: Conviction ASP `#7034` submitted its final two-service catalog on 2026-07-22. The update transaction is `0x861be48333c6ec751ea615b4122816509cfe0679b92b555ffa5815824055cf60`; marketplace approval remains pending. Production v0.4.3 passed fresh controlled house OPEN, CLOSE, and TAKE_PROFIT gates. Production v0.4.7 makes native OKX Agentic Wallet plus the official Plugin Store runtime the preferred no-Conviction-install OPEN/CLOSE path; TAKE_PROFIT retains the corrected, digest-pinned fallback. The two submitted services, prices, endpoints, inputs, and descriptions do not change, so no additional marketplace edit is required.
